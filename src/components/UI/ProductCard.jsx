...
const addToCart = () =>{
    ...
    return (
        <Col lg='3' md='4' className="mb-2">
            ...
            <div className="product__img" id="product__img">
                <motion.img whileHover={{scale: 0.9}} src={item.imgUrl} alt="" className="img" />
            </div>
            
            <div className="product__info">
            <h3 className="product__name" id="product__name">
